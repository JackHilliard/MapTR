...
for r,tok in enumerate(PICKS):
    ...
    panel(axes[r,2], tok, RUNS['c50m_EMDV2'], 'monotone OT' if r==0 else '')
...
fig.savefig(f'{OUT}/fig_preds3.png', dpi=132, facecolor=BG); plt.close(fig)
print('wrote fig_preds3.png %.2f MB'%(os.path.getsize(OUT+'/fig_preds3.png')/1e6))
