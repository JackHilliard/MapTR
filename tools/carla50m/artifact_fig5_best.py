...
json.dump({'range':[scored[-1][0],scored[0][0]],'n':len(scored)}, open(f'{OUT}/curve_range_best.json','w'))
...
fig.savefig(f'{OUT}/fig_curves_best.png',dpi=128,facecolor=BG);plt.close(fig)
print('wrote fig_curves_best.png %.2f MB'%(os.path.getsize(OUT+'/fig_curves_best.png')/1e6))
