...
log_level = 'INFO'
work_dir = '/MapTR/work_dirs/maptrv2_HM-carla_dataset_30m_dense_aligned-V2'
load_from = None
resume_from = None
workflow = [('train', 1)]
plugin = True
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_pts=dict(
            ...
            pgf_w2=0.5,
            pgf_wc=0.5,
            cwot_eps=0.034722222222222224,
            cwot_iters=50,
            cwot_squared=True,
            cwot_w_pos=1.2,
            cwot_w_dir=0.4166666666666667),
...
cost_cwot_degree = 1
loss_cwot_w_pos = 1.2
loss_cwot_w_dir = 0.4166666666666667
cost_cwot_w_pos = 1.0
cost_cwot_w_dir = 0.4166666666666667
cwot_eps_ref = 0.05
loss_cwot_eps = 0.034722222222222224
cost_cwot_eps = 0.04166666666666667
num_vec_one2one = 25
num_vec_one2many = 150
max_num = 25
gpu_ids = range(0, 1)
