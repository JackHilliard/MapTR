# EMDV2 ablation round 2 E_lr025x: loss_pts=7.07, lr=0.00015
# lr x0.25 -- C (3e-4) beat baseline by +11.0 mAP at ep12; is 3e-4 the optimum or is lower still better?
# Round 1 @ep12: C(lr3e-4) .7840 > B(geom3.54) .6798 > base .6738 > A(geom14.14) .5430 > D(lr1.2e-3) diverged
...
optimizer = dict(type='AdamW', lr=0.00015, weight_decay=0.01)
