# R1 = ablation winner C (lr 3e-4) + 2x LiDAR BEV resolution.
...
lidar_voxel_size = [0.025, 0.025, 0.4]
num_vec = 50
...
model = dict(
    ...
    lidar_encoder=dict(
        voxelize=dict(
            max_num_points=10,
            point_cloud_range=[-15.0, -15.0, -72.0, 15.0, 15.0, 96.0],
            voxel_size=[0.025, 0.025, 0.4],
            max_voxels=[300000, 375000]),
        backbone=dict(
            type='SparseEncoder',
            in_channels=4,
            sparse_shape=[1201, 1201, 421],
            output_channels=128,
            order=('conv', 'norm', 'act'),
