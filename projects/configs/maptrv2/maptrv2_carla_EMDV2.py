# AUTO-DERIVED from maptrv2_carla_ORIG.py -- identical in every respect
# EXCEPT the geometry primitive: ordered-L1 -> order-preserving (monotone)
# optimal transport, mode "emdv2". Same loss_dir (0.005), same cls_cost
# (2.0), same schedule/data, and a loss/cost weight chosen for measured
# gradient parity with PtsL1Loss (58.9x -> 1.02x). Any difference in the
# result is therefore attributable to the transport, not to reweighting.
        ...
        pts=dict(
            ...
            assigner=dict(
                ...
                pts_cost=dict(
                    ...
                    weight=7.07,
                    emdv2_pointwise_reduction='sum',
                    # OFF on purpose: the sum reduction already puts this
                    # on OrderedPtsL1Cost's scale, and re-normalising would
                    # discard exactly the calibration being tested.
