# EMDV2 ablation D_lr2x: loss_pts=7.07, lr=0.0012
# lr x2 -- baseline lr was inherited from the L1 config, never tuned for emdv2
# Baseline (85.3% mAP): loss_pts=7.07, lr=6e-4. One factor changed.
...
optimizer = dict(type='AdamW', lr=0.0012, weight_decay=0.01)
